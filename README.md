...
```text
?tenant=acme&region=reg20&device=nuc-001
```

Example:

```text
https://<deployment-domain>/?tenant=acme&region=reg20&device=nuc-001
```
...
5. test one launcher such as `/devices/reg20/nuc-001.html`
